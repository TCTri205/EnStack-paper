        ...
        try:
            with h5py.File(filepath, "r") as f:
                ...
                if "CWE-other" in cwe_cols:
                    df_labels.loc[df_labels["CWE-other"], "target"] = 4
                if "CWE-476" in cwe_cols:
                    df_labels.loc[df_labels["CWE-476"], "target"] = 3
                if "CWE-469" in cwe_cols:
                    df_labels.loc[df_labels["CWE-469"], "target"] = 2
                if "CWE-120" in cwe_cols:
                    df_labels.loc[df_labels["CWE-120"], "target"] = 1
                if "CWE-119" in cwe_cols:
                    df_labels.loc[df_labels["CWE-119"], "target"] = 0
